...
function(nuttx_generate_headers)
  ...
  if(NOT EXISTS ${CMAKE_BINARY_DIR}/include_arch/arch/chip)
    if(CONFIG_ARCH_CHIP_CUSTOM)
      execute_process(
        COMMAND
          ${CMAKE_COMMAND} -E copy_directory ${NUTTX_CHIP_ABS_DIR}/include
  ...
  # defined, then there is an architecture specific stdarg.h header file that
  # will be included indirectly from include/lib/stdarg.h.  But first, we have
  # to copy stdarg.h from include/nuttx/. to include/.
  ...
  # be included indirectly from include/math.h.  But first, we have to copy
  # math.h from include/nuttx/. to include/.  Logic within
  ...
  # defined, then there is an architecture specific setjmp.h header file that
  # will be included indirectly from include/lib/setjmp.h.  But first, we have
  # to copy setjmp.h from include/nuttx/. to include/.
