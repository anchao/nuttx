...
add_custom_target(
  ...
  COMMAND
    ...
    DRIVERS_PLATFORM_DIR=dummy APPSDIR=${NUTTX_APPS_DIR}
    APPSBINDIR=${NUTTX_APPS_BINDIR} BINDIR=${CMAKE_BINARY_DIR}
    HOST_LINUX=$<IF:$<BOOL:{LINUX}>,y,n> HOST_MACOS=$<IF:$<BOOL:${APPLE}>,y,n>
    HOST_WINDOWS=$<IF:$<BOOL:${WIN32}>,y,n>
    HOST_OTHER=$<IF:$<BOOL:${OTHER_OS}>,y,n> kconfig-mconf Kconfig
...
add_custom_target(
  ...
  COMMAND
    ...
    HOST_LINUX=$<IF:$<BOOL:{LINUX}>,y,n> HOST_MACOS=$<IF:$<BOOL:${APPLE}>,y,n>
    HOST_WINDOWS=$<IF:$<BOOL:${WIN32}>,y,n>
    HOST_OTHER=$<IF:$<BOOL:${OTHER_OS}>,y,n> kconfig-qconf Kconfig
  COMMAND ${CMAKE_COMMAND} -E remove -f
          ${CMAKE_BINARY_DIR}/include/nuttx/config.h # invalidate existing
                                                     # config
  COMMAND ${CMAKE_COMMAND} -E touch ${CMAKE_PARENT_LIST_FILE}
...
add_custom_target(
  ...
  COMMAND
    ...
    HOST_LINUX=$<IF:$<BOOL:{LINUX}>,y,n> HOST_MACOS=$<IF:$<BOOL:${APPLE}>,y,n>
    HOST_WINDOWS=$<IF:$<BOOL:${WIN32}>,y,n>
    HOST_OTHER=$<IF:$<BOOL:${OTHER_OS}>,y,n> kconfig-conf --savedefconfig
    ${CMAKE_BINARY_DIR}/defconfig.tmp Kconfig
  COMMAND kconfig-tweak --file ${CMAKE_BINARY_DIR}/defconfig.tmp -u
          CONFIG_APPS_DIR
...
add_custom_target(
  ...
  COMMAND
    ...
    HOST_LINUX=$<IF:$<BOOL:{LINUX}>,y,n> HOST_MACOS=$<IF:$<BOOL:${APPLE}>,y,n>
    HOST_WINDOWS=$<IF:$<BOOL:${WIN32}>,y,n>
    HOST_OTHER=$<IF:$<BOOL:${OTHER_OS}>,y,n> kconfig-conf --olddefconfig Kconfig
  COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_BINARY_DIR}/.config
          ${CMAKE_BINARY_DIR}/.config.orig
  COMMAND ${CMAKE_COMMAND} -E touch ${CMAKE_PARENT_LIST_FILE}
  WORKING_DIRECTORY ${NUTTX_DIR})

add_custom_target(diffconfig COMMAND kconfig-diff .config.orig .config)
