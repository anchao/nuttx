...
#define TCPIPv4BUF ((FAR struct tcp_hdr_s *)&dev->d_iob->io_data[NET_LL_HDRLEN(dev) + IPv4_HDRLEN])
#define TCPIPv6BUF ((FAR struct tcp_hdr_s *)&dev->d_iob->io_data[NET_LL_HDRLEN(dev) + IPv6_HDRLEN])
