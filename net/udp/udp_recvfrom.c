...
#define UDPIPv4BUF ((FAR struct udp_hdr_s *)&dev->d_iob->io_data[NET_LL_HDRLEN(dev) + IPv4_HDRLEN])
#define UDPIPv6BUF ((FAR struct udp_hdr_s *)&dev->d_iob->io_data[NET_LL_HDRLEN(dev) + IPv6_HDRLEN])
