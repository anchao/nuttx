...
void ce_cnt_get(int flow, char *cnt, int size);

void ce_md_get(char *dst, char *src, int size);
void ce_sha_final(void);
void ce_check_sha_end(void);

void ce_rsa_width_set(int size, ce_task_desc_t *task);
void ce_rsa_op_mode_set(int mode, ce_task_desc_t *task);

void ce_ecc_width_set(int size, ce_task_desc_t *task);
void ce_ecc_op_mode_set(int mode, ce_task_desc_t *task);

void ce_cts_last(ce_task_desc_t *task);
void ce_hmac_sha1_last(ce_task_desc_t *task);
...
int ce_reg_print(char *buf, int len);
