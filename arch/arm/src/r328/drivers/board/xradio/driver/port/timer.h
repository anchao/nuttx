...
#define XR_DRV_TIMER_ONCE OS_TIMER_ONCE

typedef OS_Timer_t XR_DRV_Timer_t;

#define xr_drv_timer_init OS_TimerCreate
#define xr_drv_timer_destroy OS_TimerDelete
#define xr_drv_timer_active OS_TimerIsActive
...
#define XR_DRV_TimerCallback_t	OS_TimerCallback_t
#define XR_DRV_TimerType		OS_TimerType
#define XR_DRV_TIMER_ONCE		OS_TIMER_ONCE
#define XR_DRV_TIMER_PERIODIC	XR_DRV_TIMER_PERIODIC

#define xr_drv_timer_init		OS_TimerCreate
#define xr_drv_timer_destroy	OS_TimerDelete
#define xr_drv_timer_active		OS_TimerIsActive
#define xr_drv_timer_change_period		OS_TimerChangePeriod
#define xr_drv_timer_stop		OS_TimerStop
/*
