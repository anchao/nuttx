...
#define MAX_FIFU 64
#define BULK_DATA_BOUNDARY 0       /* can modify to adapt the application */
...
typedef enum sunxi_spi_sync_mode_e
{
	SUNXI_SPI_ASYNC = 0,
	SUNXI_SPI_SYNC,
}hal_spi_sync_mode_e;
...
typedef enum sunxi_spi_trans_mode_e
{
  SUNXI_SPIDEV_MODE0 = 0,     /* CPOL=0 CHPHA=0 */
  SUNXI_SPIDEV_MODE1,         /* CPOL=0 CHPHA=1 */
  SUNXI_SPIDEV_MODE2,         /* CPOL=1 CHPHA=0 */
  SUNXI_SPIDEV_MODE3,         /* CPOL=1 CHPHA=1 */
  SUNXI_SPIDEV_MODETI,        /* CPOL=0 CPHA=1 TI Synchronous Serial Frame Format */
