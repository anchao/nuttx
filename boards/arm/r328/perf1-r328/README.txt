...
==============
  ...
  can be selected as follow:
    ...
    tools/configure.sh [OPTIONS] perf1-r328:<subdir>
  ...
  nsh:
    ...
    STATUS:
      ...
      nuttx/boards/arm/r328/perf1-r328/nsh/pcduino-140107.patch is applied.  This patchfile
      ...
      a) nuttx/arch/arm/src/armv7-a/arm_head.S: Initializes the MMU so that A10
         ...
         in r328_boot.c (see the next item).

      b) nuttx/arch/arm/src/r328/r328_boot.c:  This file contains several arbitrary
